                    ...
                    {parsedDep > 0 && (
                      <div className="space-y-3 mt-1.5">
                        <span className="text-[10px] font-mono text-slate-400 block leading-tight">
                          Depositing {parsedDep.toLocaleString()} {depositAsset}{" "}
                          → receive ~{depSharesPreview.toLocaleString()} LP
                          Shares
                        </span>
                        <SimulationPreview
                          details={simDetails}
                  ...
                  <div>
                    ...
                    {parsedWith > 0 && (
                      <span className="text-[10px] font-mono text-slate-400 block mt-1.5 leading-tight">
                        Redeeming {parsedWith.toLocaleString()} Shares → receive
                        ~{withUsdcPreview.toLocaleString()} USDC
                      </span>
                    )}
                  </div>
                  <Button
