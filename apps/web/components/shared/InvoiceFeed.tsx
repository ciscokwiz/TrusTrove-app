...
const mockFeedItems: FeedItem[] = [
  {
    id: "1",
    type: "Lagos Textile Supplier",
    amount: "$34,500 USDC",
    time: "Funded 3 min ago",
    discount: "2.1%",
    flag: "🇳🇬",
  },
  {
    id: "2",
    type: "Nairobi Agri-Exporter",
    amount: "$18,200 USDC",
    time: "Funded 8 min ago",
    discount: "1.8%",
    flag: "🇰🇪",
  },
  {
    id: "3",
    type: "Accra Electronics",
    amount: "$52,000 USDC",
    time: "Funded 12 min ago",
    discount: "2.5%",
    flag: "🇬🇭",
  },
  {
    id: "4",
    type: "Mombasa Logistics",
    amount: "$27,800 USDC",
    time: "Funded 22 min ago",
    discount: "2.0%",
    flag: "🇰🇪",
  },
  {
    id: "5",
    type: "Dakar Fish Processing",
    amount: "$41,300 USDC",
    time: "Funded 35 min ago",
    discount: "2.3%",
    flag: "🇸🇳",
  },
  {
    id: "6",
    type: "Kampala Agri-Hub",
    amount: "$15,400 USDC",
    time: "Funded 42 min ago",
    discount: "1.9%",
    flag: "🇺🇬",
  },
  {
    id: "7",
    type: "Kumasi Cocoa Exporter",
    amount: "$63,000 USDC",
    time: "Funded 58 min ago",
    discount: "2.4%",
    flag: "🇬🇭",
  },
];
            ...
            >
              ...
              <div className="text-right shrink-0">
                ...
                <span className="text-[9px] font-mono text-sky-400 font-semibold block flex items-center justify-end gap-0.5">
                  <ArrowDownLeft className="w-2.5 h-2.5" /> {item.discount}{" "}
                  disc.
                </span>
              </div>
            </motion.div>
